    ...
    var r = {
        ...
        606: function (e, t, r) {
          ...
          function c(e, t, r) {
            return Number.isFinite(e)
              ? Math.round(t * e + Math.max(0, e - 1) * r)
              : e;
          }
          function f(e, t, r, n, o, a) {
            ...
            return (
              a && a.resizing
                ? ((p.width = Math.round(a.resizing.width)),
                  (p.height = Math.round(a.resizing.height)))
                : ((p.width = c(n, f, i[0])), (p.height = c(o, u, i[1]))),
              a && a.dragging
                ? ((p.top = Math.round(a.dragging.top)),
                  (p.left = Math.round(a.dragging.left)))
                : ((p.top = Math.round((u + i[1]) * r + s[1])),
                  (p.left = Math.round((f + i[0]) * t + s[0]))),
              p
            );
          }
                  ...
                  if (a) {
                    ...
                    if (u) {
                      var l = u.getBoundingClientRect(),
                        ...
                        y = c.top / i,
                        h = l.top / i;
                      (s.left = f - d + u.scrollLeft),
                        (s.top = y - h + u.scrollTop),
                    ...
                    if (y) {
                      ...
                      if (w) {
                        var O = e.props,
                          S = O.margin,
                          j = O.rowHeight;
                        (s = d(s, 0, w.clientHeight - c(b, j, S[1]))),
                          (u = d(u, 0, m - c(g, l(v), S[0])));
                      }
                    }
                    var P = { top: s, left: u };
                  ...
                  value: function (e) {
                    ...
                    return (
                      r.useCSSTransforms
                        ...
                        : ((t = (0, u.setTopLeft)(e)),
                          n &&
                            ((t.left = (0, u.perc)(e.left / o)),
                            (t.width = (0, u.perc)(e.width / o)))),
                      t
                    );
                  },
                },
                  ...
                  value: function () {
                    var e = this.props,
                      ...
                      y = o().cloneElement(d, {
                        ...
                        style: j(
                          j(j({}, this.props.style), d.props.style),
                          this.createStyle(p)
                        ),
                      });
                    return (
                      (y = this.mixinResizable(y, p, u)),
                      this.mixinDraggable(y, i)
                    );
                  },
                },
              ]),
            ...
            function f() {
              ...
              return (
                  ...
                  if (y) {
                    ...
                    (l = (0, u.moveElement)(
                      ...
                      e.setState({
                        layout: p
                          ? l
                          : (0, u.compact)(l, (0, u.compactType)(e.props), f),
                        activeDrag: h,
                      });
                  }
                }),
                  ...
                  if (e.state.activeDrag) {
                    ...
                    if (y) {
                      (l = (0, u.moveElement)(
                        ...
                        e.props.onDragStop(l, s, y, null, a, i);
                      var h = d
                          ? l
                          : (0, u.compact)(l, (0, u.compactType)(e.props), f),
                        g = e.state.oldLayout;
                      ...
                      if (d && !y) {
                        ...
                        if ((t = o.length > 0)) {
                          ...
                          o.forEach(function (t) {
                            t.x > e.x && (a = Math.min(a, t.x)),
                              t.y > e.y && (i = Math.min(i, t.y));
                          }),
                  ...
                  if (m) {
                    ...
                    e.props.onResize(b, c, m, v, a, i),
                      e.setState({
                        layout: y
                          ? b
                          : (0, u.compact)(b, (0, u.compactType)(e.props), p),
                        activeDrag: v,
                      });
                  }
                }),
                Y(U(e), "onResizeStop", function (t, r, n, o) {
                  ...
                  var h = d
                      ? l
                      : (0, u.compact)(l, (0, u.compactType)(e.props), p),
                    g = e.state.oldLayout;
                  e.setState({
                    activeDrag: null,
                    layout: h,
                ...
                Y(U(e), "onDragOver", function (t) {
                  ...
                  if (
                    ...
                    t.stopPropagation(),
                    G &&
                      (null === (r = t.nativeEvent.target) ||
                        void 0 === r ||
                        !r.classList.contains(F)))
                  )
                    return !1;
                  var o = e.props,
                    a = o.droppingItem,
                  ...
                  if (!1 === h)
                    return (
                      e.state.droppingDOMNode && e.removeDroppingPlaceholder(),
                      !1
                    );
                  var g = H(H({}, a), h),
                    b = e.state.layout,
                    ...
                    e.setState({
                      ...
                      layout: [].concat(T(b), [
                        H(
                          H({}, g),
                          {},
                          { x: D.x, y: D.y, static: !1, isDraggable: !0 }
                        ),
                      ]),
                    });
                  }
                ...
                Y(U(e), "onDrop", function (t) {
                  ...
                  (e.dragEnterCounter = 0),
                    e.removeDroppingPlaceholder(),
                    e.props.onDrop(n, o, t);
                }),
                e
              );
            }
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    t || (t = this.state.layout),
                      i()(t, e) || this.props.onLayoutChange(e);
                  },
                },
                {
                  key: "placeholder",
                  ...
                  value: function (e, t) {
                    if (e && e.key) {
                      ...
                      var o = this.props,
                        ...
                        P =
                          "boolean" == typeof r.isDraggable
                            ? r.isDraggable
                            : !r.static && p,
                        D =
                          "boolean" == typeof r.isResizable
                            ? r.isResizable
                            : !r.static && d,
                        x = r.resizeHandles || v,
                        R = P && y && !1 !== r.isBounded;
        ...
        94: function (e, t, r) {
          ...
          var D = (function (e) {
            ...
            function y() {
              ...
              return (
                S(
                  w((e = f.call.apply(f, [this].concat(r)))),
                  "state",
                ...
                S(w(e), "onLayoutChange", function (t) {
                  e.props.onLayoutChange(
                    t,
                    h(h({}, e.props.layouts), {}, S({}, e.state.breakpoint, t))
                  );
                }),
                e
              );
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (s !== i || e.breakpoints !== r || e.cols !== n) {
                      ...
                      var p = (0, l.findOrGenerateResponsiveLayout)(
                        f,
                        r,
                        i,
                        s,
          ...
          S(D, "propTypes", {
            ...
            layouts: function (e, t) {
              if ("[object Object]" !== j(e[t]))
                throw new Error(
                  "Layout property must be an object. Received: " + j(e[t])
                );
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        return r && !this.mounted
                          ...
                          : n.createElement(
                              e,
                              l({ innerRef: this.elementRef }, o, this.state)
                            );
                      },
                    },
                  ]) && f(r.prototype, o),
        ...
        271: function (e, t, r) {
          ...
          function i(e, t, r, o, a, i) {
            ...
            return (
              (u = (0, n.cloneLayout)(u || [])),
              (0, n.compact)((0, n.correctBounds)(u, { cols: a }), i, a)
            );
          }
          function s(e) {
        ...
        872: function (e, t, r) {
          ...
          function f(e) {
            for (var t = Array(e.length), r = 0, n = e.length; r < n; r++)
              t[r] = y(e[r]);
            return t;
          }
          function p(e, t) {
            for (var r = Array(e.length), n = 0, o = e.length; n < o; n++)
          ...
          function v(e, t, r) {
            for (
              ...
              var u = y(o[i]);
              u.static || ((u = S(n, u, t, r, o)), n.push(u)),
                (a[e.indexOf(o[i])] = u),
                (u.moved = !1);
            }
            return a;
          ...
          function S(e, t, r, n, o) {
            var a,
              i = "horizontal" === r;
            if ("vertical" === r)
              for (t.y = Math.min(c(e), t.y); t.y > 0 && !D(e, t); ) t.y--;
            else if (i) for (; t.x > 0 && !D(e, t); ) t.x--;
            for (; (a = D(e, t)); )
              i ? O(o, t, a.x + a.w, "x") : O(o, t, a.y + a.h, "y"),
                i && t.x + t.w > n && ((t.x = n - t.w), t.y++);
          ...
          function _(e, t, r, n, o, a, i, s, u) {
            ...
            "Moving element "
              .concat(t.i, " to [")
              .concat(String(r), ",")
              .concat(String(n), "] from [")
              .concat(t.x, ",")
              .concat(t.y, "]");
            var l = t.x,
              c = t.y;
            "number" == typeof r && (t.x = r),
              "number" == typeof n && (t.y = n),
              (t.moved = !0);
            var p = T(e, i);
            ("vertical" === i && "number" == typeof n
              ? c >= n
              : "horizontal" === i && "number" == typeof r && l >= r) &&
              (p = p.reverse());
            var d = x(p, t),
              y = d.length > 0;
            if (y && u) return f(e);
            if (y && a)
              return (
                "Collision prevented on ".concat(t.i, ", reverting."),
                (t.x = l),
                (t.y = c),
                (t.moved = !1),
                e
            ...
            for (var h = 0, g = d.length; h < g; h++) {
              ...
              "Resolving collision between "
                ...
                .concat(b.y, "]"),
                b.moved ||
                  (e = b.static ? z(e, b, t, o, i, s) : z(e, t, b, o, i, s));
            }
            return e;
          }
            ...
            i().Children.forEach(t, function (t) {
              if (null != (null == t ? void 0 : t.key)) {
                ...
                if (r) a.push(y(r));
                  ...
                  n
                    ? a.push(y(u(u({}, n), {}, { i: t.key })))
                    : a.push(
                        y({ w: 1, h: 1, x: 0, y: c(a), i: String(t.key) })
                      );
                }
              }
            });
        ...
        307: function (e, t, r) {
          ...
          var L,
            ...
            U = I.toString,
            X = B.hasOwnProperty,
            Y = (L = /[^.]+$/.exec((q && q.keys && q.keys.IE_PROTO) || ""))
              ? "Symbol(src)_1." + L
              : "",
            F = B.toString,
            G = RegExp(
          ...
          function De(e, t, r, n, o, a) {
            ...
            for (a.set(e, t), a.set(t, e); ++c < s; ) {
              ...
              if (p) {
                if (
                  !T(t, function (e, t) {
                    if (((i = t), !p.has(i) && (d === e || o(d, e, r, n, a))))
                      return p.push(t);
                    var i;
                  })
                ) {
          ...
          function qe(e) {
            return null != (t = e) && We(t.length) && !Ne(t)
              ...
              : (function (e) {
                  if (
                    ((r = (t = e) && t.constructor),
                    t !== (("function" == typeof r && r.prototype) || B))
                  )
                    return re(e);
                  var t,
                    r,
                  ...
                  for (var o in Object(e))
                    X.call(e, o) && "constructor" != o && n.push(o);
                  return n;
                })(e);
            var t;
          }
            ...
            function h(e) {
              ...
              return (
                ...
                D(j((t = y.call(this, e))), "onDragStart", function (e, r) {
                  if (
                    ((0, p.default)("Draggable: onDragStart: %j", r),
                    !1 ===
                      t.props.onStart(e, (0, l.createDraggableData)(j(t), r)))
                  )
                    return !1;
                ...
                D(j(t), "onDragStop", function (e, r) {
                  ...
                  if (
                    !1 ===
                    t.props.onStop(e, (0, l.createDraggableData)(j(t), r))
                  )
                    return !1;
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this.state.isElementSVG
                      ? (v = (0, u.createSVGTransform)(S, y))
                      : (b = (0, u.createCSSTransform)(S, y));
                    var j = (0, s.default)(
                      r.props.className || "",
                      a,
                      (D((e = {}), i, this.state.dragging),
                      D(e, c, this.state.dragged),
                      e)
                    );
                    return o.createElement(
                      f.default,
                  ...
                  O(v(e), "handleDragStop", function (t) {
                    if (e.state.dragging) {
                      ...
                      if (null != r) {
                        ...
                        i &&
                          e.props.enableUserSelectHack &&
                          (0, s.removeUserSelectStyles)(i.ownerDocument),
                          (0, c.default)(
          ...
          Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            (t.innerHeight = function (e) {
              var t = e.clientHeight,
                r = e.ownerDocument.defaultView.getComputedStyle(e);
              return (
                (t -= (0, o.int)(r.paddingTop)) - (0, o.int)(r.paddingBottom)
              );
            }),
            (t.innerWidth = function (e) {
              var t = e.clientWidth,
                r = e.ownerDocument.defaultView.getComputedStyle(e);
              return (
                (t -= (0, o.int)(r.paddingLeft)) - (0, o.int)(r.paddingRight)
              );
            }),
            ...
            (t.removeUserSelectStyles = function (e) {
              if (e)
                try {
                  if (
                    (e.body &&
                      y(e.body, "react-draggable-transparent-selection"),
                    e.selection)
                  )
                    e.selection.empty();
                  else {
            ...
            (t.getBoundPosition = function (e, t, r) {
              ...
              if ("string" == typeof i) {
                ...
                if (
                  !(
                    (u =
                      "parent" === i
                        ? s.parentNode
                        : l.querySelector(i)) instanceof c.HTMLElement
                  )
                )
                  throw new Error(
                ...
                i = {
                  left:
                    -s.offsetLeft +
                    (0, n.int)(d.paddingLeft) +
                    (0, n.int)(p.marginLeft),
                  top:
                    -s.offsetTop +
                    (0, n.int)(d.paddingTop) +
                    (0, n.int)(p.marginTop),
                  right:
                    (0, o.innerWidth)(f) -
                    (0, o.outerWidth)(s) -
                    s.offsetLeft +
                    (0, n.int)(d.paddingRight) -
                    (0, n.int)(p.marginRight),
                  bottom:
                    (0, o.innerHeight)(f) -
                    (0, o.outerHeight)(s) -
                    s.offsetTop +
                    (0, n.int)(d.paddingBottom) -
          ...
          var y = (function (e) {
            ...
            function i() {
              for (
                ...
                n[o] = arguments[o];
              return (
                ((t = e.call.apply(e, [this].concat(n)) || this).handleRefs =
                  {}),
            ...
            return (
              ...
              (u.resizeHandler = function (e, t) {
                ...
                return function (n, o) {
                  ...
                  var u =
                      ("both" === r.props.axis || "x" === r.props.axis) &&
                      "n" !== t &&
                      "s" !== t,
                    l =
                      ("both" === r.props.axis || "y" === r.props.axis) &&
                      "e" !== t &&
                      "w" !== t;
                  if (u || l) {
                    var c = t[0],
                    ...
                    null != r.lastHandleRect &&
                      ("w" === f && (i += p.left - r.lastHandleRect.left),
                      "n" === c && (s += p.top - r.lastHandleRect.top)),
                      (r.lastHandleRect = p),
                      "w" === f && (i = -i),
                      "n" === c && (s = -s);
                    var d =
                        r.props.width + (u ? i / r.props.transformScale : 0),
              ...
              (u.renderResizeHandle = function (e, t) {
                ...
                var o = f(
                  { ref: t },
                  "string" == typeof r.type ? {} : { handleAxis: e }
                );
                    ...
                    {},
                    {
                      ...
                      children: [].concat(
                        ...
                        c.map(function (t) {
                          var r,
                            a =
                              null != (r = e.handleRefs[t])
                                ? r
                                : (e.handleRefs[t] = n.createRef());
                          return n.createElement(
                            o.DraggableCore,
                            l({}, u, {
                              nodeRef: a,
