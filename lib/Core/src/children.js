import { flattenChildren } from "./tools.js";
import { cloneElement, MyReactVDom } from "./vdom.js";
...
export const map = (arrayLike, action) => {
  return mapByJudgeFunction(arrayLike, (v) => v instanceof MyReactVDom, action);
};
...
export const forEach = (arrayLike, action) => {
  mapByJudgeFunction(arrayLike, (v) => v instanceof MyReactVDom, action);
};
