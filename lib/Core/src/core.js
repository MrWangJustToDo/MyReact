...
import { isEqual, isNormalEqual, getIsPortalRender } from "./tools.js";
import { pushPosition, pushUnmount, pushUpdate } from "./update.js";
...
function getNewFiberWithUpdate(
  ...
  if (isSameType) {
    ...
    if (
      matchedPreviousRenderChild.__isDynamicNode__ &&
      Object.is(matchedPreviousRenderChild.__vdom__, newVDom)
    ) {
      return updateFiberNode(previousRenderChild, parentFiber, newVDom);
    }
