...
import { enableEventSystem, enableControlComponent, isMounted } from "./env.js";
import { pushFiber } from "./fiberTool.js";
import { MyReactHookNode } from "./hook.js";
import { MyReactInstance } from "./instance.js";
import { processUpdatePosition } from "./position.js";
import { MyReactTypeInternalInstance } from "./share.js";
import { pushUpdate } from "./update.js";
        ...
        if (this.__INTERNAL_EVENT_STATE__[cacheEventName]) {
          ...
          const handler = (...args) => {
            ...
            if (enableControlComponent.current) {
              if (
                this.__isPlainNode__ &&
                this.__vdom__.type === "input" &&
                // todo more event, like change
                event === "input" &&
                "value" in this.memoProps
              ) {
