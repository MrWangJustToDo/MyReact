  ...
  updateFromAlternate() {
    if (this.fiberAlternate) {
      ...
      if (fiberAlternate !== this) {
        ...
        this.__internal_suspense_state__ = Object.assign(
          {},
          fiberAlternate.__internal_suspense_state__
        );
      ...
      if (isValidElement(vdom)) {
        ...
        if (!vdom.__validType__) {
          ...
          if (this.__isSuspense__) {
            if (
              this.__vdom__.children === undefined ||
              this.__vdom__.children === null
            ) {
