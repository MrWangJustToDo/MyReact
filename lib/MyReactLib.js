...
function commitStart(currentFiber) {
  ...
  if (currentRootFiber) {
    if (!currentRootFiber.alternate) {
      // getAlternate(currentRootFiber);
    }
...
function getAlternate(fiber) {
  if (fiber) {
    ...
    getAlternate(fiber.child);
    getAlternate(fiber.slibing);
  }
}
...
function nextWork(fiber) {
  if (fiber.type === "h1") {
    console.log(Object.assign({}, fiber));
    console.log(fiber);
  }
  // if (!fiber.alternate) {
  //   console.log("没有", Object.assign({}, fiber));
  // } else {
  //   console.log("有的", Object.assign({}, fiber));
  // }
...
function transformChildren(fiber, children) {
  ...
  // console.log(Object.assign({}, previousFiber));
