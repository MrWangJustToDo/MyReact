...
function getNewFiberWithUpdate(newVDom, parentFiber, previousRenderChild, matchedPreviousRenderChild, isSameType) {
  if (isSameType) {
    ...
    if (matchedPreviousRenderChild.__isPlainNode__ && (0, _tools.isEqual)(matchedPreviousRenderChild.__vdom__.props, newVDom.props)) {
      ...
      if (matchedPreviousRenderChild !== previousRenderChild) {
        _fiber2.diffMount = true;
        var isPortalRender = getIsPortalRender(previousRenderChild);
        _fiber2.diffPrevRender = isPortalRender ? null : previousRenderChild;
        (0, _update.pushPosition)(_fiber2.fiberParent);
      }
    ...
    if (matchedPreviousRenderChild !== previousRenderChild) {
      _fiber.diffMount = true;

      var _isPortalRender = getIsPortalRender(previousRenderChild);

      _fiber.diffPrevRender = _isPortalRender ? null : previousRenderChild;
      (0, _update.pushPosition)(_fiber.fiberParent);
    }
  ...
  if (_env.isMounted.current) {
    ...
    var _isPortalRender2 = getIsPortalRender(previousRenderChild);

    fiber.diffPrevRender = _isPortalRender2 ? null : previousRenderChild;
...
exports.rootFiber = exports.rootContainer = exports.pendingUpdateFiberArray = exports.pendingUnmountFiberArray = exports.pendingPositionFiberArray = exports.pendingModifyFiberArray = exports.pendingLayoutEffectArray = exports.pendingEffectArray = exports.nextTransformFiberArray = exports.needLoop = exports.isMounted = exports.enableKeyDiff = exports.enableHighLight = exports.empty = exports.currentTransformFiberArray = exports.currentRunningFiber = exports.currentHookDeepIndex = exports.currentFunctionFiber = void 0;
...
var enableHighLight = (0, _tools.createRef)(true);
...
function commitUpdate(currentFiber, parentDom) {
  if (currentFiber.dom) {
    ...
    if (currentFiber.effect === "PLACEMENT") {
      ...
      (0, _dom.updateDom)(currentFiber.dom, currentFiber.__isTextNode__ ? _env.empty : currentFiber.fiberAlternate.__vdom__.props, currentFiber.__isTextNode__ ? _env.empty : currentFiber.__vdom__.props, currentFiber); // highLightDom(currentFiber);
    }
...
function isPortalRender(fiber) {
  ...
  if (fiber.__isPortal__) return true;
  if (fiber.dom) return false;
  return isPortalRender(fiber.fiberChildHead);
}

function getDomOrIsPortalRender(fiber) {
  if (!fiber) throw new Error("update error");
}
/**
 *
 * @param {MyReactFiberNode} fiber
