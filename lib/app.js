...
class HighLight {
  ...
  highLight = fiber => {
    if (_env.enableHighLight.current && fiber.dom) {
...
function insertBefore(fiber, beforeDom, parentDom) {
  ...
  if (fiber.__isPlainNode__ || fiber.__isTextNode__) return parentDom.insertBefore(fiber.dom, beforeDom);
...
function append(fiber, parentDom) {
  ...
  fiber.effect = null;
  if (fiber.__isPortal__) return;
  if (fiber.__isPlainNode__ || fiber.__isTextNode__) return parentDom.append(fiber.dom);
...
exports.getNativeEventName = exports.getFiberNodeName = exports.getDom = exports.getContextFiber = exports.flattenChildren = exports.createRef = exports.childrenCount = exports.Provider = exports.Portal = exports.Memo = exports.Fragment = exports.ForwardRef = exports.Context = exports.Consumer = void 0;
