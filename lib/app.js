...
function processUpdatePosition(fiber, previousRenderChild) {
  ...
  var isPortalRender = (0, _tools.getIsPortalRender)(previousRenderChild);
...
function getNewFiberWithUpdate(newVDom, parentFiber, previousRenderChild, matchedPreviousRenderChild, isSameType) {
  if (isSameType) {
    ...
    if (matchedPreviousRenderChild.__isContextProvider__ && (0, _tools.isNormalEqual)(matchedPreviousRenderChild.__vdom__.props.value, newVDom.props.value)) {
      return (0, _fiber3.updateFiberNode)(previousRenderChild, parentFiber, newVDom);
    } // 优化dynamic render，当使用的children为同一个引用时，不会再次执行


    if (matchedPreviousRenderChild.__isDynamicNode__ && Object.is(matchedPreviousRenderChild.__vdom__, newVDom)) {
      return (0, _fiber3.updateFiberNode)(previousRenderChild, parentFiber, newVDom);
    }
...
function memo(MemoRender) {
  ...
  return MemoObject; // class Memo extends MyReactPureComponent {
...
exports.getFiberNodeName = exports.getDom = exports.getContextFiber = exports.createRef = exports.Provider = exports.Portal = exports.Memo = exports.Fragment = exports.ForwardRef = exports.Context = exports.Consumer = void 0;
exports.getIsPortalRender = getIsPortalRender;
exports.getNativeEventName = void 0;
