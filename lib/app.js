(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
   ...
   * @returns
   */
  function getNewFiberWithUpdate(newVDom, parentFiber, previousRenderChild, isSameType) {
    if (isSameType) {
      if (Array.isArray(newVDom)) {
        return newVDom.map(function (v, index) {
          return getNewFiberWithUpdate(v, parentFiber, previousRenderChild[index], isSameTypeNode(v, previousRenderChild[index]));
        });
      }
  
      if (!previousRenderChild) return null;
  
      if (previousRenderChild.__isTextNode__ && previousRenderChild.__vdom__ === newVDom) {
        return (0, _fiber2.updateFiberNode)(previousRenderChild, parentFiber, newVDom);
      }
  
      if (previousRenderChild.__isPlainNode__ && (0, _tools.isEqual)(previousRenderChild.__vdom__.props, newVDom.props)) {
        return (0, _fiber2.updateFiberNode)(previousRenderChild, parentFiber, newVDom);
      }
      ...
      var _fiber = (0, _fiber2.createFiberNode)({
        ...
        effect: previousRenderChild.__isTextNode__ || previousRenderChild.__isPlainNode__ ? "UPDATE" : null
  ...
  function transformChildrenFiber(parentFiber, _children) {
    ...
    while (index < children.length || index < previousRenderChildren.length) {
      ...
      var isSameType = _env.isMounted.current && isSameTypeNode(newChild, previousRenderChild);
      var newFiber = isNewChildren ? getNewFiberWithInitial(newChild, parentFiber) : getNewFiberWithUpdate(newChild, parentFiber, previousRenderChild, isSameType);
      !isSameType && previousRenderChild && (0, _update.pushUnmount)(previousRenderChild);
  ...
  function updateDom(element, oldProps, newProps, fiber) {
    if (fiber.__isTextNode__) {
      ...
      Object.keys(newProps).filter(_tools.isProperty).filter((0, _tools.isNew)(oldProps, newProps)).forEach(function (key) {
        return element[key] = newProps[key];
      });
  ...
  exports.rootFiber = exports.rootContainer = exports.pendingUpdateFiberArray = exports.pendingUnmountFiberArray = exports.pendingPositionFiberArray = exports.pendingModifyFiberArray = exports.pendingLayoutEffectArray = exports.pendingEffectArray = exports.nextTransformFiberArray = exports.needLoop = exports.isMounted = exports.empty = exports.currentTransformFiberArray = exports.currentRunningFiber = exports.currentHookDeepIndex = exports.currentFunctionFiber = void 0;
  ...
  var MyReactHookNode = /*#__PURE__*/function (_MyReactInstance) {
    ...
    function MyReactHookNode(hookIndex, _value, depArray, hookType, hookNext, hookPrev, cancel, effect) {
      var _this;
  ...
  function mountLoop(currentFiber, parentDom) {
    if (currentFiber && currentFiber.mount) {
      ...
      mountLoop(currentFiber.fiberFirstChild, currentFiber.dom || parentDom);
  ...
  exports.safeCall = exports.map = exports.logFiber = exports.isStyle = exports.isProperty = void 0;
  ...
  exports.map = map;
  },{"./env.js":4,"./fiber.js":5}],12:[function(require,module,exports){
  "use strict";
    ...
    for (var i = children.length - 1; i >= 0; i--) {
      ...
      if (_fiber.diffMount) {
        if (_fiber.fiberPrevRender) {
          insertBefore(_fiber, (0, _tools.getDom)(_fiber.fiberPrevRender, function (fiber) {
            return fiber.fiberFirstChild;
          ...
          // new create
          if (_fiber.fiberNext) {
            insertBefore(_fiber, (0, _tools.getDom)(_fiber.fiberNext, function (fiber) {
              return fiber.fiberFirstChild;
            }), (0, _tools.getDom)(_fiber.fiberParent, function (fiber) {
              return fiber.fiberParent;
            }) || _env.rootContainer.current);
  ...
  function runPosition(fiber) {
    ...
    allPositionArray.forEach(commitPosition);
