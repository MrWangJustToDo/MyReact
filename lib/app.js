...
var getNewFiberWithUpdate = function getNewFiberWithUpdate(newVDom, parentFiber, previousRenderChild, matchedPreviousRenderChild) {
  ...
  if (isSameType) {
    ...
    var currentMatchedPreviousRenderChild = matchedPreviousRenderChild.effect ? matchedPreviousRenderChild.fiberAlternate : matchedPreviousRenderChild; // matchedPreviousRenderChild.fiberAlternate
...
var commitHydrate = function commitHydrate(fiber, parentDom) {
  if (fiber.__isPlainNode__ || fiber.__isTextNode__ && fiber.__vdom__ !== "") {
...
var createUpdatedFiberNodeWithUpdateAndPosition = function createUpdatedFiberNodeWithUpdateAndPosition(_ref6, vdom, previousRenderFiber) {
  ...
  if (newFiber.fiberAlternate !== previousRenderFiber) {
    (0, _position.pushPosition)(newFiber, previousRenderFiber);
  }
    ...
    value: function updateFromAlternate() {
      if (this.fiberAlternate) {
        ...
        if (fiberAlternate !== this) {
          ...
          this.hookList = fiberAlternate.hookList;
          this.hookHead = fiberAlternate.hookHead;
          this.hookFoot = fiberAlternate.hookFoot;
          this.instance = fiberAlternate.instance;
          this.dependence = fiberAlternate.dependence;
          this.__internal_node_type__ = fiberAlternate.__internal_node_type__;
          this.__internal_event_state__ = fiberAlternate.__internal_event_state__; // update
...
},{"../debug.js":8,"../dom/index.js":13,"../fiber/index.js":21}],44:[function(require,module,exports){
"use strict";
