...
var MyReactComponentInternalState = /*#__PURE__*/function (_MyReactInstance) {
  _inherits(MyReactComponentInternalState, _MyReactInstance);

  var _super = _createSuper(MyReactComponentInternalState);

  function MyReactComponentInternalState() {
    var _this;

    _classCallCheck(this, MyReactComponentInternalState);
  ...
  _createClass(MyReactComponentInternalState, [{
    key: "updateInstance",
  ...
  return MyReactComponentInternalState;
}(_share.MyReactInstance);

var MyReactComponentInternalInstance = /*#__PURE__*/function (_MyReactComponentInte) {
  _inherits(MyReactComponentInternalInstance, _MyReactComponentInte);

  var _super2 = _createSuper(MyReactComponentInternalInstance);
...
}(MyReactComponentInternalState);

var MyReactComponent = /*#__PURE__*/function (_MyReactComponentInte2) {
  _inherits(MyReactComponent, _MyReactComponentInte2);

  var _super3 = _createSuper(MyReactComponent);
...
var MyReactPureComponent = /*#__PURE__*/function (_MyReactComponent) {
  ...
  var _super4 = _createSuper(MyReactPureComponent);
...
},{"./core.js":2,"./effect.js":4,"./env.js":6,"./fiber.js":7,"./share.js":13,"./tools.js":14}],2:[function(require,module,exports){
"use strict";
...
},{"./component.js":1,"./env.js":6,"./fiber.js":7,"./render.js":12,"./tools.js":14}],4:[function(require,module,exports){
"use strict";
...
var MyReactFiberEventHandlerInstance = /*#__PURE__*/function (_MyReactFiberInternal) {
  _inherits(MyReactFiberEventHandlerInstance, _MyReactFiberInternal);

  var _super2 = _createSuper(MyReactFiberEventHandlerInstance);

  function MyReactFiberEventHandlerInstance() {
    var _this2;

    _classCallCheck(this, MyReactFiberEventHandlerInstance);
    ...
    _defineProperty(_assertThisInitialized(_this2), "__INTERNAL_EVENT_STATE__", {});

    _defineProperty(_assertThisInitialized(_this2), "__INTERNAL_EVENT_SYSTEM__", {
      addEventListener: function addEventListener(event, cb, isCapture) {
        if (_env.enableEventSystem.current) {
          ...
          if (_this2.__INTERNAL_EVENT_STATE__[cacheEventName]) {
            _this2.__INTERNAL_EVENT_STATE__[cacheEventName].cb = cb;
          } else {
            var handler = function handler() {
              ...
              if (_env.enableControlComponent.current) {
                if (_this2.__isPlainNode__ && _this2.__vdom__.type === "input" && // todo more event, like change
                event === "input" && "value" in _this2.memoProps) {
            ...
            handler.cb = cb;
            _this2.__INTERNAL_EVENT_STATE__[cacheEventName] = handler;

            _this2.dom.addEventListener(event, handler, isCapture);
          }
        } else {
          if (_env.enableControlComponent.current) {
          ...
          _this2.dom.addEventListener(event, cb, isCapture);
        }
      },
      removeEventListener: function removeEventListener(event, cb, isCapture) {
        if (_env.enableEventSystem.current) {
          ...
          _this2.__INTERNAL_EVENT_STATE__[cacheEventName].cb = null;
        } else {
          _this2.dom.removeEventListener(event, cb, isCapture);
        }
      }
    });
  ...
  return _createClass(MyReactFiberEventHandlerInstance);
}(MyReactFiberInternalInstance);

var MyReactFiberNode = /*#__PURE__*/function (_MyReactFiberEventHan) {
  _inherits(MyReactFiberNode, _MyReactFiberEventHan);

  var _super3 = _createSuper(MyReactFiberNode);
  ...
  instance) {
    ...
    _this3.dom = dom;
    _this3.hookHead = hookHead;
    _this3.hookFoot = hookFoot;
    _this3.hookList = hookList;
    _this3.listeners = listeners;
    _this3.instance = instance;

    _this3._initialUpdate();

    _this3._initialParent();
...
}(MyReactFiberEventHandlerInstance);
/**
 *
...
exports.ReactDOM = exports.React = exports.PureComponent = exports.Component = exports.Children = void 0;
...
},{"./fiber.js":7,"./tools.js":14}],14:[function(require,module,exports){
"use strict";
...
var MyReactVDomInternalState = /*#__PURE__*/function (_MyReactTypeInternalI) {
  _inherits(MyReactVDomInternalState, _MyReactTypeInternalI);

  var _super = _createSuper(MyReactVDomInternalState);

  function MyReactVDomInternalState() {
    var _this;

    _classCallCheck(this, MyReactVDomInternalState);
  ...
  _createClass(MyReactVDomInternalState, [{
    key: "__clonedNode__",
    get: function get() {
  ...
  return MyReactVDomInternalState;
}(_share.MyReactTypeInternalInstance);

var MyReactVDomInternalInstance = /*#__PURE__*/function (_MyReactVDomInternalS) {
  _inherits(MyReactVDomInternalInstance, _MyReactVDomInternalS);

  var _super2 = _createSuper(MyReactVDomInternalInstance);
  ...
  function MyReactVDomInternalInstance() {
    ...
    _defineProperty(_assertThisInitialized(_this2), "ref", void 0);

    _defineProperty(_assertThisInitialized(_this2), "props", void 0);

    _defineProperty(_assertThisInitialized(_this2), "children", void 0);
...
var MyReactVDom = /*#__PURE__*/function (_MyReactVDomInternalI) {
  ...
  function MyReactVDom(type, props, children) {
    ...
    _this3.key = key;
    _this3.ref = ref;
    _this3.props = resProps;
    _this3.children = children;

    _this3._processType();

    _this3._checkValidVDom();
