const appEntry_5da6ed44e16c8 =
  "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/react.js";
var allModuleName = {
  ...allModuleName,
  ...{
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/react.js":
      "32c4722a5899e",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/component.js":
      "17b0e8f1a4804",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/dom.js":
      "796bc0b83e91b",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/element.js":
      "ced9a140057cf",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/hook.js":
      "abfbfc38938c5",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/tools.js":
      "04ddd8c3ff6e",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/vdom.js":
      "2ebd63033620d",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/core.js":
      "b49c5b3df9eb8",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/effect.js":
      "14521b1ce6dc3",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/fiber.js":
      "bc4d98390710f",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/share.js":
      "38fe0321c3a84",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/env.js":
      "dcb8d6b0161ff",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/render.js":
      "157647e261c0c",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/unmount.js":
      "a9b67ec0f116e",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/position.js":
      "76c3999407fdf",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/update.js":
      "898e32adf774b",
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/mount.js":
      "755b79142d5b5",
  },
};
var allModuleContent = {
  ...allModuleContent,
  ...{
    "32c4722a5899e": function anonymous(require, module, exports) {
      "use strict";
    ...
    "17b0e8f1a4804": function anonymous(require, module, exports) {
      "use strict";
      ...
      function processComponentInstanceLifeCircle(fiber) {
        const Component = fiber.__vdom__.type;
        const providerFiber = (0, _tools.getContextFiber)(
          fiber,
    ...
    "796bc0b83e91b": function anonymous(require, module, exports) {
      "use strict";
      ...
      function updateDom(element, oldProps, newProps, fiber) {
        if (fiber.__isTextNode__) {
          ...
          Object.keys(oldProps)
            ...
            .forEach((styleKey) => {
              Object.keys(oldProps[styleKey] || _env.empty)
                .filter((0, _tools.isGone)(newProps[styleKey] || _env.empty))
                .forEach((styleName) => {
                ...
                .forEach((styleName) => {
                  if (!isUnitlessNumber[styleName]) {
                    if (typeof newProps[styleKey][styleName] === "number") {
                      element.style[
                        styleName
                      ] = `${newProps[styleKey][styleName]}px`;
                      return;
                    }
                  }
    ...
    ced9a140057cf: function anonymous(require, module, exports) {
      "use strict";
    ...
    abfbfc38938c5: function anonymous(require, module, exports) {
      "use strict";
      ...
      function useDebugValue(...args) {
        if (_env.enableDebugLog.current) {
          console.log(
            ...
            "\n",
            `tree:`,
            (0, _tools.logCurrentRunningFiber)()
          );
        }
      }
    },
    "04ddd8c3ff6e": function anonymous(require, module, exports) {
      "use strict";
      ...
      exports.getNativeEventName =
        ...
        exports.debuggerFiber =
        exports.createRef =
        exports.childrenCount =
        exports.Provider =
        exports.Portal =
        exports.Memo =
        exports.Fragment =
      ...
      exports.updateAsyncTimeStep =
        exports.shouldYieldAsyncUpdateOrNot =
        exports.safeCall =
        exports.mapVDom =
        exports.mapFiber =
        exports.map =
        exports.logHook =
        exports.logFiber =
        exports.logCurrentRunningFiber =
        exports.isStyle =
        exports.isProperty =
          void 0;
      ...
      const isNew = (oldProps, newProps) => (key) =>
      ...
      const logCurrentRunningFiber = () =>
        logFiber(_env.currentRunningFiber.current);
      /**
       *
       * @param {MyReactHookNode} hookNode
      ...
      const mapVDom = (arrayLike, action) =>
        map(arrayLike, (v) => v instanceof _vdom.MyReactVDom, action);

      exports.mapVDom = mapVDom;

      const mapFiber = (arrayLike, action) =>
        map(arrayLike, (f) => f instanceof _fiber.MyReactFiberNode, action); // in progress
    ...
    "2ebd63033620d": function anonymous(require, module, exports) {
      "use strict";
          ...
          if (_env.enableAllCheck.current && !this.__validType__) {
            ...
            if (this.__isMemo__ || this.__isForwardRef__) {
              if (typeof this.type.render !== "function") {
                if (
                  typeof this.type.render !== "object" ||
    ...
    b49c5b3df9eb8: function anonymous(require, module, exports) {
      "use strict";
      ...
      function getNewFiberWithUpdate(
        ...
        if (isSameType) {
          ...
          if (Object.is(matchedPreviousRenderChild.__vdom__, newVDom)) {
            return (0, _fiber.updateFiberNodeWithPosition)(
              matchedPreviousRenderChild,
              parentFiber,
              previousRenderChild,
              newVDom
          ...
          if (
            ...
            (0, _tools.isEqual)(
              matchedPreviousRenderChild.__vdom__.props,
              newVDom.props
            )
          ) {
            return (0, _fiber.updateFiberNodeWithPosition)(
        ...
        return (0, _fiber.createFiberNodeWithPosition)(
          {
            ...
            deepIndex: parentFiber.deepIndex + 1,
            effect:
              newVDom !== null && newVDom !== void 0 && newVDom.__isPortal__
                ? "PORTAL"
                : "PLACEMENT",
          },
          {
          ...
          if (tempRenderChildren.length) {
            if (vdom instanceof _vdom.MyReactVDom && vdom.key !== undefined) {
              const targetIndex = tempRenderChildren.findIndex(
                (fiber) =>
                  fiber instanceof _fiber.MyReactFiberNode &&
                  fiber.key === vdom.key
              );
      ...
      function transformChildrenFiber(parentFiber, _children) {
        ...
        const previousRenderChildren =
          ...
          _parentFiber$fiberAlt === void 0
            ? void 0
            : _parentFiber$fiberAlt.__renderedChildren__) || [];
        ...
        while (
          ...
          const isSameType =
            _env.isMounted.current &&
            isSameTypeNode(newChild, assignPreviousRenderChild);
      ...
      function nextWorkMemo(fiber) {
        ...
        if (fiber.initial || fiber.__needUpdate__) {
          const { render: _render, isMyReactForwardRefRender } =
            fiber.__vdom__.type;
    ...
    "14521b1ce6dc3": function anonymous(require, module, exports) {
      "use strict";
    ...
    bc4d98390710f: function anonymous(require, module, exports) {
      "use strict";
      ...
      exports.createFiberNodeWithUpdateAndPosition =
    ...
    "38fe0321c3a84": function anonymous(require, module, exports) {
      "use strict";
    ...
    dcb8d6b0161ff: function anonymous(require, module, exports) {
      "use strict";
    ...
    "157647e261c0c": function anonymous(require, module, exports) {
      "use strict";
      ...
      function transformStart(fiber) {
        _env.currentTransformFiberArray.current.push(
          ...(0, _core.nextWork)(fiber)
        );
      }
      ...
      function transformCurrent() {
        while (_env.currentTransformFiberArray.current.length) {
          ...
          _env.nextTransformFiberArray.current.push(
            ...(0, _core.nextWork)(fiber)
          );
        }
      }
      ...
      function loopAll(getNextFiber, cb) {
        ...
        while (!shouldYield) {
          if (
            _env.currentTransformFiberArray.length ||
            _env.nextTransformFiberArray.current
          ) {
          ...
          const hasNext =
            _env.currentTransformFiberArray.current.length ||
            _env.nextTransformFiberArray.current.length;
    ...
    a9b67ec0f116e: function anonymous(require, module, exports) {
      "use strict";
    ...
    "76c3999407fdf": function anonymous(require, module, exports) {
      "use strict";
        ...
        for (let i = children.length - 1; i >= 0; i--) {
          ...
          if (childFiber.__diffMount__) {
            if (fiber.__isPlainNode__ || fiber.__isPortal__) {
              ...
              const beforeDom =
                getInsertBeforeDomFromSiblingAndParent(childFiber);

              if (beforeDom) {
                insertBefore(
                  childFiber,
                  beforeDom,
                  (0, _tools.getDom)(fiber, (f) => f.fiberParent) ||
    ...
    "898e32adf774b": function anonymous(require, module, exports) {
      "use strict";
      ...
      function getSyncPendingModifyFiberArray() {
        const pendingUpdate = _env.pendingModifyFiberArray.current
          .slice(0)
          .filter((f) => f.__needUpdate__ && f.mount);

        pendingUpdate.sort((f1, f2) =>
      ...
      function updateAllSync() {
        ...
        (0, _tools.safeCall)(() =>
          pendingUpdate.forEach(_render.renderLoopSync)
        );
    ...
    "755b79142d5b5": function anonymous(require, module, exports) {
      "use strict";
...
// start
require(appEntry_5da6ed44e16c8);
