...
function createElement(type, props, ...children) {
  ...
  } else if (type === MReact.Fragment) {
    return createVDom(type, null, null, props, children, type);
  } else {
...
function getNodeNameFromFiber(fiber) {
  ...
  if (fiber.__isEmptyNode__ || fiber.__isFragmentNode__)
    return `<${fiber.__isEmptyNode__ ? "empty" : "Fragment"} - (${
