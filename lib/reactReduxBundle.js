...
const enableControlComponent = (0, _tools.createRef)(true);
        ...
        if (this.__INTERNAL_EVENT_STATE__[cacheEventName]) {
          ...
          const handler = (...args) => {
            ...
            if (_env.enableControlComponent.current) {
              if (this.__isPlainNode__ && this.__vdom__.type === "input" && // more event, like change
              event === "input" && "value" in this.memoProps) {
