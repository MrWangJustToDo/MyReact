...
const appEntry_0577c68bd7037 = '/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/redux/redux.js';
var allModuleName = {...allModuleName, ...{'/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/redux/redux.js':"a453796a851ca", 
}};
var allModuleContent = {...allModuleContent, ...{'a453796a851ca':function anonymous(require,module,exports
) {
...
const createStore = (reducers, initialState, middleware) => {
  ...
  targetMiddleware = targetMiddleware ? targetMiddleware(store) : [];

  const originalDispatch = store.dispatch;

  const dispatch = targetMiddleware.length
...
// start 
require(appEntry_0577c68bd7037)
