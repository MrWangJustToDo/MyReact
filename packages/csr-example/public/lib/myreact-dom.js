    ...
    ***************************************************************************** */
    ...
    var PlainElement = /** @class */ (function () {
        ...
        PlainElement.prototype.serializeStyle = function () {
            ...
            if (styleKeys.length)
                return "style=\"".concat(styleKeys.map(function (key) { var _a; return "".concat(lodash.exports.kebabCase(key), ": ").concat((_a = _this.style[key]) === null || _a === void 0 ? void 0 : _a.toString(), ";"); }).reduce(function (p, c) { return p + c; }), "\"");
            return "";
        };
