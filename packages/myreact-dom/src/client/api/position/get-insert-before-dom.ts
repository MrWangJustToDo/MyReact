...
function findFiberWithDOMFromFiber(fiber: MyReactFiberNode | null): MyReactFiberNode | null {
...
function getInsertBeforeDomFromSibling(fiber: MyReactFiberNode | null): MyReactFiberNode | null {
 ...
 * @internal
 */
export function getInsertBeforeDomFromSiblingAndParent(fiber: MyReactFiberNode | null, parentFiber: MyReactFiberNode | null): MyReactFiberNode | null {
  if (!fiber) return null;
