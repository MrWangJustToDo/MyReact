...
export function mountControl(renderDispatch: ClientDomDispatch, fiber: MyReactFiberNode) {
...
export function updateControl(renderDispatch: ClientDomDispatch, fiber: MyReactFiberNode) {
