...
import { onceLogNewEntry } from "./create-root";
...
function hydrateRootImpl(container: Partial<RenderContainer>, element: LikeJSX, _option?: Options) {
...
export const hydrateRoot = wrapperFunc(hydrateRootImpl);
