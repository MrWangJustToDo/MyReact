...
import { DomPlatform, DomScope, startRender, startRenderAsync, unmountComponentAtNode } from "../../shared";
...
export const renderAsync = async (element: MyReactElement, container: RenderContainer) => {
  const containerFiber = container.__fiber__;
