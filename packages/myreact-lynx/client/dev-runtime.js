(function () {
    ...
    ***************************************************************************** */
    ...
    var WebSocketClient = /** @class */ (function () {
        ...
        WebSocketClient.prototype.connect = function () {
            ...
            this.ws.onmessage = function (event) {
                try {
                    var _a = JSON.parse(event.data), eventName = _a.event, data = _a.data;
        ...
        WebSocketClient.prototype.trigger = function (event, data) {
            var _a;
            (_a = this.listeners.get(event)) === null || _a === void 0 ? void 0 : _a.forEach(function (cb) { return cb(data); });
        };
    ...
    var wsClient = function (_a) {
        var url = _a.url, name = _a.name, options = _a.options;
        core.clearSubscribe();
    ...
    var initBundleWS_DEV = function (url) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b, _c, _d;
