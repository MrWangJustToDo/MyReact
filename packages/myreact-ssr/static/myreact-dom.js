(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var MyReactFiberNodeClass$3 = react.__my_react_internal__.MyReactFiberNode, NODE_TYPE$3$1 = react.__my_react_internal__.NODE_TYPE, UPDATE_TYPE$3 = react.__my_react_internal__.UPDATE_TYPE;
    ...
    var _updateFiberNodeWithDev = function () {
        ...
        var _a = props[0], fiber = _a.fiber, parent = _a.parent, prevFiber = _a.prevFiber, newElement = props[1];
                ...
                if (react.isValidElement(element)) {
                    if (typeof element.key === "string") {
                        var targetIndex = tempChildren.findIndex(function (fiber) {
                            var _a;
                            return fiber instanceof MyReactFiberNodeClass$3 &&
    ...
    var NODE_TYPE$2$1 = react.__my_react_internal__.NODE_TYPE, Effect_TYPE$1 = react.__my_react_internal__.Effect_TYPE, UPDATE_TYPE$2 = react.__my_react_internal__.UPDATE_TYPE;
    ...
    var processComponentStateFromProps = function (fiber) {
        ...
        var Component = fiber.type & NODE_TYPE$2$1.__isDynamicNode__
            ? typedElement.type
    ...
    var processComponentDidMountOnMount = function (fiber) {
        ...
        if (strictMod) {
            if ((typedInstance.componentDidMount || typedInstance.componentWillUnmount) &&
    ...
    var processComponentShouldUpdateOnUpdate = function (fiber, _a) {
        ...
        var typedInstance = fiber.instance;
        if (fiber.mode & UPDATE_TYPE$2.__trigger__)
            return true;
    ...
    var nextWorkSync = function (fiber) {
        if (!fiber.mount)
            return [];
        if (!(fiber.mode & (UPDATE_TYPE$1.__run__ | UPDATE_TYPE$1.__trigger__)))
            return [];
    ...
    var createHookNode = function (props, fiber) {
        ...
        if (hookNode.hookType === HOOK_TYPE$1.useMemo ||
            hookNode.hookType === HOOK_TYPE$1.useState ||
            hookNode.hookType === HOOK_TYPE$1.useReducer) {
            hookNode.result = hookNode.value.call(null);
            return hookNode;
        }
        if (hookNode.hookType === HOOK_TYPE$1.useEffect ||
    ...
    var isNew = function (oldProps, newProps) { return function (key) {
    ...
    var unmountFiber = function (fiber) {
        react.__my_react_shared__.unmountFiberNode(fiber);
        clearFiberDom(fiber);
    };
    ...
    var generateReconcileUpdate = function (globalDispatch, globalScope) { return function () {
        ...
        allPendingList.forEach(function (l) { return globalDispatch.reconcileCreate(l); });
    ...
    var generateUpdateControllerWithDispatch = function (globalDispatch, globalScope) {
        ...
        var controller = {
            ...
            doesPause: function () { return controller.currentYield !== null; },
    ...
    var asyncUpdate = function (globalDispatch, globalScope) {
        return Promise.resolve().then(function () { return updateEntry(globalDispatch, globalScope); });
    };
                ...
                Promise.resolve().then(function () {
                    ...
                    allFiber.forEach(function (f) {
                        ...
                        f.type & NODE_TYPE$5.__isTextNode__
                            ? _this.range.selectNodeContents(f.node)
                            : _this.range.selectNode(f.node);
    ...
    var nativeUpdate = function (fiber, isSVG) {
        ...
        var isAppMounted = fiber.root.scope.isAppMounted;
        if (isAppMounted &&
    ...
    var ClientDispatch = /** @class */ (function () {
        ...
        ClientDispatch.prototype.reconcileUpdate = function (_list) {
            _list.listToHead(function (_fiber) {
                if (_fiber.mount) {
                    var _parentFiberWithDom_1 = getFiberWithDom$1(_fiber.parent, function (f) { return f.parent; });
                    safeCallWithFiber$1({
                        fiber: _fiber,
                        action: function () { return position(_fiber, _parentFiberWithDom_1); },
                    });
                }
            });
            _list.listToFoot(function (_fiber) {
                if (_fiber.mount) {
                    var _parentFiberWithDom_2 = getFiberWithDom$1(_fiber.parent, function (f) { return f.parent; });
                    safeCallWithFiber$1({
                        fiber: _fiber,
                        action: function () { return append$2(_fiber, _parentFiberWithDom_2); },
                    });
                }
            });
