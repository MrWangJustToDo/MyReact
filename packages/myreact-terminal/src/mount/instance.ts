...
import { logUpdate, renderer, type LogUpdate } from "../api";
import { ContainerElement } from "../api/native";
...
export class Instance {
  ...
  constructor(options: Options) {
    ...
    this.rootNode = new ContainerElement("terminal-root");
  ...
  onRender: () => void = () => {
    ...
    const { output, outputHeight, staticOutput } = renderer(this.rootNode);
  ...
  render = (node: MyReactElementNode): void => {
    const tree = createElement(App, {
...
export const instances = new WeakMap<NodeJS.WriteStream, Instance>();
