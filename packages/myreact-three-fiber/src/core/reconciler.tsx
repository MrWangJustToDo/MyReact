...
export function extend<T extends Catalogue | ConstructorRepresentation>(objects: T): React.ExoticComponent<ThreeElement<any>> | void {
...
function removeChild(parent: HostConfig["instance"], child: HostConfig["instance"] | HostConfig["textInstance"], dispose?: boolean) {
  if (!child) return;
