(function (global, factory) {
  ...
  var append$2 = function (fiber, parentFiberWithDom) {
    if (fiber.patch & PATCH_TYPE$c.__pendingAppend__) {
      ...
      if (fiber.patch & PATCH_TYPE$c.__pendingAppend__) fiber.patch ^= PATCH_TYPE$c.__pendingAppend__;
    }
  };
  ...
  var getFiberWithDom = function (fiber, transform) {
    ...
    if (fiber.type & (NODE_TYPE$8.__isPlainNode__ | NODE_TYPE$8.__isTextNode__)) return fiber;
      ...
      this.flashPending = function () {
        Promise.resolve().then(function () {
          ...
          allFiber.forEach(function (f) {
            ...
            f.type & NODE_TYPE$5.__isTextNode__ ? _this.range.selectNodeContents(f.node.element) : _this.range.selectNode(f.node.element);
  ...
  var append = function (fiber, parentFiberWithDom) {
    if (fiber.patch & PATCH_TYPE$3.__pendingAppend__) {
      ...
      if (fiber.patch & PATCH_TYPE$3.__pendingAppend__) fiber.patch ^= PATCH_TYPE$3.__pendingAppend__;
    }
  };
  ...
  var create = function (fiber) {
    if (fiber.patch & PATCH_TYPE$2.__pendingCreate__) {
      ...
      if (fiber.patch & PATCH_TYPE$2.__pendingCreate__) fiber.patch ^= PATCH_TYPE$2.__pendingCreate__;
    }
  };
  ...
  var update = function (fiber) {
    if (fiber.patch & PATCH_TYPE$1.__pendingUpdate__) {
      ...
      if (fiber.patch & PATCH_TYPE$1.__pendingUpdate__) fiber.patch ^= PATCH_TYPE$1.__pendingUpdate__;
    }
  };
