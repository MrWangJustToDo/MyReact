...
import { render, Box, Text, useApp, useInput, useStdout } from "@my-react/react-terminal";
...
function AlternateBufferExample() {
  ...
  // height.
  return (
    <Box borderStyle="single" width={stdout.columns} height={stdout.rows + 30} justifyContent="center" alignItems="center">
      <Box flexDirection="column" alignItems="center">
        ...
        {exiting ? (
          ...
          <Text>
            Time: {time.toLocaleTimeString()}.{time.getMilliseconds().toString().padStart(3, "0")}
          </Text>
        )}
      </Box>
    </Box>
