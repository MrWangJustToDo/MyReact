import React, { useState, useEffect } from "@my-react/react";
import { render, Text, Box, useInput, useStdout, useApp } from "@my-react/react-terminal";
...
export const test = () => render(<IncrementalRendering />, { incrementalRendering: true });
